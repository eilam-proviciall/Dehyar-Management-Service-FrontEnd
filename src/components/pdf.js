...
function view(targetRef) {
    return (
        <Box>
            <Grid container ref={targetRef} sx={{p: 15}}>
                ...
                <Grid item xs={12} sx={{mt: 5}}>
                    <Grid container sx={{border: '3px solid #dfdfdf'}}>
                        ...
                        <Grid item xs={5} sx={mainStyle}>
                            ۲۴- دﺳﺘﻤﺰد ﻣﺎﻫﯿﺎﻧﻪ ﺑﻪ ﺷﺮح زﯾﺮ تعیین ﻣﯿﺸﻮد: دﺳﺘﻤﺰد ﻣﺎﻫﯿﺎﻧﻪ ﺑﻪ ﺷﺮح زﯾﺮ تعیین ﻣﯿﺸﻮد : ﺑﺮﺳﺎس
                            دﺳﺘﻮراﻟﻌﻤﻞ ﻧﺤﻮه
                            تعیین ﺣﻘﻮق و ﻣﺰاﯾﺎی اﻣﻮر ﻣﺎﻟی ﻣﻮﺿﻮع ﺑﺨﺸﻨﺎﻣﻪ ﺷﻤﺎره ۱۶۱۹۸ و کﺸﻮر دﻫﯿﺎرﯾﻬﺎی و ﻫﺎ ﺷﻬﺮداری ﺳﺎزﻣﺎن
                            ۱۴۰۲/۰۴/۰۳
                            ﻣﻮرخ ﺑﺨﺸﻨﺎﻣﻪ ﺷﻤﺎره ۱۳۴۵۹۹/ت۵۸۷۵۶ ﺷﻮرا ﻋﺎﻟی کﺎر ﺣﻘﻮق و ﻣﺰاﯾﺎی ﺷﻤﺎ ﻃﺒﻖ ارﻗﺎم ﻣﻨﺪرج در ردﯾﻒ ۲۳
                            اﯾﻦ ﺣکﻢ تعیین
                        ...
                        <Grid item xs={12} sx={mainStyle}>
                            ۲۵- ﻃﺮف ﻗﺮارداد ﺗﺎﺑﻊ ﻣﻘﺮرات،ﺿﻮاﺑﻂ و آﺋﯿﻦ ﻧﺎﻣﻪ ﻫﺎی ﻣﺮﺑﻮط ﺑﻪ دﻫﯿﺎری ، ﻗﺎﻧﻮن کار و ﻗﺎﻧﻮن ﺗﺎﻣﯿﻦ
                            اﺟﺘﻤﺎﻋی ﺑﻮده و
                        ...
                        <Grid item xs={12} sx={mainStyle}>
                            ۲۷- ﻣﺎﻣﻮرﯾﺖ و ﻣﺮﺧﺼی اﻣﻮرﻣﺎﻟی دﻫﯿﺎری ﺑﻪ اﺳﺘﻨﺎد اﺻﻼﺣﯿﻪ ﻣﺎده ۱۲ آﺋﯿﻦ ﻧﺎﻣﻪ اﺳﺘﺨﺪاﻣی دﻫﯿﺎری ﻫﺎی
                            کﺸﻮر ﺑﺎ تایید
                            ﺑﺨﺸﺪار ﺻﻮرت ﻣی گﯿﺮد.
                        </Grid>
                        <Grid item xs={12} sx={mainStyle}>
                            ۲۸ - ﻣﺰاﯾﺎی پﺎﯾﺎن ﻗﺮارداد ﻃﺒﻖ ﻗﺎﻧﻮن کﺎر و ﺑﺮاﺳﺎس ﺣﻘﻮق و دﺳﺘﻤﺰد ﻣﻨﺪرج در ﻗﺮارداد از ﻣﺤﻞ
                            اﻋﺘﺒﺎرات دﻫﯿﺎری ﻫﺎی
                        ...
                        <Grid item xs={12} sx={mainStyle}>
                            ...
                            <Typography sx={{color: '#000'}}>
                                - ﻋﻘﺪ ﻗﺮارداد ﻫﯿچ گﻮﻧﻪ ﺗﻌﻬﺪی ﻣﺒﻨی ﺑﺮ اﺳﺘﺨﺪام اﻋﻢ از رﺳﻤی ﯾﺎ پﯿﻤﺎﻧی اﻋﻢ از ﺳﻮی دﻫﯿﺎری
                                ﺑﺮای ﻃﺮف ﻗﺮارداد
                                اﯾﺠﺎد ﻧﻤی کﻨﺪ.
                            </Typography>
                            <Typography sx={{color: '#000'}}>
                        ...
                        <Grid item xs={12} sx={mainStyle}>
                            ۳۰- اﻣﻀﺎی ذﯾﻞ اﯾﻦ ﻗﺮارداد از ﺳﻮی ﺑﺨﺸﺪار ﺻﺮﻓﺎ ﺟﻬﺖ اﺟﺮای ﻣﺎده ۱۶ اﺳﺎﺳﻨﺎﻣﻪ ، ﺗﺴﻬﯿﻼت و ﺳﺎزﻣﺎن
                            دﻫﯿﺎری ﻫﺎ ﻣﺼﻮب
                            ۱۳۸۰ و اﻣﻀﺎی ﻣﺴﺌﻮل اﻣﻮرﻣﺎﻟی دﻫﯿﺎری دﻫﯿﺎری ﺑﻪ اﺳﺘﻨﺎد ﻣﺎده ۱۱ آﻦ ﻧﺎﻣﻪ اﺳﺘﺨﺪاﻣی دﻫﯿﺎری ﻫﺎی
                            کﺸﻮر ﻣﺼﻮب ۱۳۸۳ ﻣی
                            ﺑﺎﺷﺪ دﻫﯿﺎری پﺎکﻞ گﺮاب ﺑﻪ ﻧﻤﺎﯾﻨﺪگی از دﻫﯿﺎری ﻫﺎی ﺑﻨﺪ ۲ اﯾﻦ ﻗﺮارداد ﺑﻪ ﻋﻨﻮان دﻫﯿﺎری کﺎرﻓﺮﻣﺎ
                            ﺗﻌﻦ ﻣی گﺮدد.
                        </Grid>
                        <Grid item xs={12} sx={mainStyle}>
                            ۳۱- اﯾﻦ ﻗﺮارداد در ۵ ﻧﺴﺨﻪ ﺗﻨﻈﯿﻢ و ﻫﺮ ﻧﺴﺨﻪ ﺣکﻢ واﺣﺪ را دارد و پﺲ از اﻣﻀﺎ و ﻣﻬﺮ و ﺛﺒﺖ ﻣﻌﺘﺒﺮ
                            ﺧﻮاﻫﺪ ﺑﻮد.
                        </Grid>
                        <Grid item xs={4} sx={mainStyle}>
